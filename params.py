...
initial_wood: int = 500
initial_stone: int = 500
...
max_level_warehouse: int = 3                # the maximum allowed level of the warehouse
max_diff_level_mines: int = 7

cost_estimation_parameter: float = 0.98     # determines how much the algorithm should underestimate needed time to reach a final state, do not set to >1.0
